...
void TcpConnection::send(const char* msg,const long long size)
{
    _sockIO.writen(msg, size);
}



void TcpConnection::receive(char* buff,const long long size)
{
    _sockIO.readn(buff, size);
}
